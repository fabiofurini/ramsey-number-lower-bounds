...
//#define PRINT_SOLUTION_MODEL_4
//#define PRINT_SOLUTION_CALLBACK
//#define PRINT_MODEL_4_LP
...
/***********************************************************************************/
void RAMSEY_MODEL_4_allocation(data *RAMSEY_instance)
/***********************************************************************************/
{
	RAMSEY_instance->n_variable_MODEL_4=RAMSEY_instance->PARAM_SIZE_GRAPH/2.0 + 1;
	...
	RAMSEY_instance->X_CALLBACK=new double[RAMSEY_instance->n_variable_MODEL_4];

	RAMSEY_instance->cut_rmatind=new int[RAMSEY_instance->n_variable_MODEL_4];
	RAMSEY_instance->cut_rmatval=new double[RAMSEY_instance->n_variable_MODEL_4];

	RAMSEY_instance->X_MODEL_4=new double[RAMSEY_instance->n_variable_MODEL_4];
...
/***********************************************************************************/
void RAMSEY_MODEL_4_deallocation(data *RAMSEY_instance)
/***********************************************************************************/
{
	...
	delete []RAMSEY_instance->X_MODEL_4;
...
/***********************************************************************************/
int CPXPUBLIC mycutcallback_LAZY_MODEL_4(CPXCENVptr env,void *cbdata,int wherefrom,void *cbhandle,int *useraction_p)
/***********************************************************************************/
{
	...
	RAMSEY_instance->status=CPXgetcallbacknodex(env,cbdata,wherefrom,RAMSEY_instance->X_CALLBACK,0,RAMSEY_instance->n_variable_MODEL_4-1);
	...
	cout << "\n\nSOL:\n";
	for(int i=0; i<RAMSEY_instance->n_variable_MODEL_4; i++)
	{
	...
	cout << "THETA\t" << RAMSEY_instance->X_CALLBACK[RAMSEY_instance->n_variable_MODEL_4-1] << endl;
	cin.get();
	...
	for(int i=0;i<RAMSEY_instance->PARAM_SIZE_GRAPH;i++)
	{
		...
		{
			if(RAMSEY_instance->X_CALLBACK[mapping(RAMSEY_instance,i,j)]<0.5){RAMSEY_instance->edge_fixing[i][j]=0;}
			else{RAMSEY_instance->edge_fixing[i][j]=1;}
		}
	}
	//		cout << "edge_fixing blue\t" << endl;
	//		for(int i=0;i<RAMSEY_instance->PARAM_SIZE_GRAPH;i++)
	//		{
	//			for(int j=0;j<RAMSEY_instance->PARAM_SIZE_GRAPH;j++)
	//			{
	//				cout << RAMSEY_instance->edge_fixing[i][j];
	//			}
	//			cout << endl;
	//		}
	//		cout << endl;
	...
	if( (int) (RAMSEY_instance->X_CALLBACK[RAMSEY_instance->n_variable_MODEL_4 - 1] +0.5) < (int) (RAMSEY_instance->CLIQUE_VAL+0.5) )
	{
		RAMSEY_instance->cut_RHS=RAMSEY_instance->CLIQUE_VAL - RAMSEY_instance->CLIQUE_VAL*(RAMSEY_instance->CLIQUE_VAL - 1)/2;
		...
		RAMSEY_instance->cut_rmatind[RAMSEY_instance->n_variable_MODEL_4 - 1]=RAMSEY_instance->n_variable_MODEL_4 - 1;
		RAMSEY_instance->cut_rmatval[RAMSEY_instance->n_variable_MODEL_4 - 1]=1.0;
	...
	if(RAMSEY_instance->SKIP_N_SEPARATION==false)
	{
		...
		for(int i=0;i<RAMSEY_instance->PARAM_SIZE_GRAPH;i++)
		{
			for(int j=i+1;j<RAMSEY_instance->PARAM_SIZE_GRAPH;j++)
			{
				if(1-RAMSEY_instance->X_CALLBACK[mapping(RAMSEY_instance,i,j)]<0.5){RAMSEY_instance->edge_fixing[i][j]=0;}
				else{RAMSEY_instance->edge_fixing[i][j]=1;}
			}
		}

		//		cout << "edge_fixing red\t" << endl;
		//		for(int i=0;i<RAMSEY_instance->PARAM_SIZE_GRAPH;i++)
		//		{
		//			for(int j=0;j<RAMSEY_instance->PARAM_SIZE_GRAPH;j++)
		//			{
		...
		if(RAMSEY_instance->CLIQUE_VAL >= RAMSEY_instance->PARAM_N )
		{
			...
			if(RAMSEY_instance->PARAM_STRONGER_CUTS==0 || RAMSEY_instance->CLIQUE_VAL == RAMSEY_instance->PARAM_N)
			{
				...
				if (RAMSEY_instance->PARAM_COVER_CUTS >= 1)
				{
					for(int i=0; i<RAMSEY_instance->n_variable_MODEL_4; i++)
					{
						RAMSEY_instance->cut_rmatval[i]=min(RAMSEY_instance->cut_rmatval[i],RAMSEY_instance->cut_RHS);
					}
				}
...
/***********************************************************************************/
void RAMSEY_MODEL_4_parameter_setting(data *RAMSEY_instance)
/***********************************************************************************/
{


	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_HEURFREQ, RAMSEY_instance->HEURFREQ);
	...
	CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_SCRIND, CPX_ON);


	// * Set number of CPU*

	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_THREADS, RAMSEY_instance->NUMBER_OF_THREADS);
	if (RAMSEY_instance->status)
	{
	...
	//	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_PARALLELMODE, CPX_PARALLEL_DETERMINISTIC);
	//	if (RAMSEY_instance->status)
	//	{
	...
	RAMSEY_instance->status = CPXsetdblparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_TILIM,RAMSEY_instance->PARAM_TIME_LIMIT);
	if (RAMSEY_instance->status)
	{
	...
	RAMSEY_instance->status = CPXsetdblparam (RAMSEY_instance->env_MODEL_4, CPXPARAM_MIP_Limits_TreeMemory, 1024*4);
	if (RAMSEY_instance->status)
	{
	...
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_MIPEMPHASIS,CPX_MIPEMPHASIS_FEASIBILITY);
	if (RAMSEY_instance->status)
	{
	...
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_NODESEL, RAMSEY_instance->TREE_EXPLORATION_STRATEGY);
	if (RAMSEY_instance->status)
	{
	...
	//
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPXPARAM_MIP_Strategy_VariableSelect,RAMSEY_instance->BRANCHING_VARIABLE_SELECTION);
	if (RAMSEY_instance->status)
	{
		printf ("error for CPX_PARAM_MIPEMPHASIS\n");
	}
	...
	CPXsetintparam(RAMSEY_instance->env_MODEL_4, CPX_PARAM_MIPCBREDLP, CPX_OFF);        // let MIP callbacks work on the original model
	//	CPXsetintparam(RAMSEY_instance->env_MODEL_4, CPX_PARAM_PRELINEAR, CPX_OFF);              // assure linear mappings between the presolved and original models
	CPXsetintparam(RAMSEY_instance->env_MODEL_4, CPX_PARAM_REDUCE, CPX_PREREDUCE_PRIMALONLY);
	//	CPXsetintparam(RAMSEY_instance->env_MODEL_4, CPXPARAM_Preprocessing_Reduce, CPX_PREREDUCE_PRIMALONLY);
	//	CPXsetintparam(RAMSEY_instance->env_MODEL_4, CPXPARAM_Preprocessing_Linear, 0);


	RAMSEY_instance->status = CPXsetlazyconstraintcallbackfunc(RAMSEY_instance->env_MODEL_4,mycutcallback_LAZY_MODEL_4,RAMSEY_instance);
	if (RAMSEY_instance->status)
	{
	...
	RAMSEY_instance->status = CPXsetintparam(RAMSEY_instance->env_MODEL_4, CPX_PARAM_RANDOMSEED, RAMSEY_instance->RANDOM_SEED);
	if (RAMSEY_instance->status )
	{
	...
	if( RAMSEY_instance->BRANCHING_STRATEGY>0)
	{
		...
		cout << "\n\n***SETTING_BRANCHING_PRIORITIESs***\n\n";

		//setting the branching priorities of the branching variables
		RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, 		CPX_PARAM_MIPORDIND,1);
		if (RAMSEY_instance->status)
		{
			printf ("error for CPX_PARAM_MIPORDIND\n");
		}

		int *indices=new int[RAMSEY_instance->n_variable_MODEL_4];
		int *priority=new int[RAMSEY_instance->n_variable_MODEL_4];
		int *direction=new int[RAMSEY_instance->n_variable_MODEL_4];
		...
		int counter_local=0;
		for(int i=0; i<RAMSEY_instance->n_variable_MODEL_4-1; i++)
		{
		...
		RAMSEY_instance-> status = CPXcopyorder (RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4, RAMSEY_instance->n_variable_MODEL_4-1, indices, priority,direction);
		if (RAMSEY_instance->status)
		{
	...
	{
		RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_NODELIM, RAMSEY_instance->PARAM_CUT_LOOP);
		if (RAMSEY_instance->status)
		{
		...
		RAMSEY_instance->status=CPXmipopt(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4);
		if(RAMSEY_instance->status!=0)
		{
		...
		RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_4, CPX_PARAM_NODELIM, 2100000000);
		if (RAMSEY_instance->status)
		{
			printf ("error for CPX_PARAM_EPRHS\n");
		}
...
/***********************************************************************************/
{
	...
	//////////////////////////////////////////////////
	RAMSEY_MODEL_4_parameter_setting(RAMSEY_instance);
	//////////////////////////////////////////////////
	...
	bool SOL_FOUND=true;
	RAMSEY_instance->status=CPXgetmipx(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4,RAMSEY_instance->X_MODEL_4,0,RAMSEY_instance->n_variable_MODEL_4-1);
	if(RAMSEY_instance->status!=0)
	{
		SOL_FOUND=false;
	...
	RAMSEY_instance->status=CPXgetmipobjval(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4,&(RAMSEY_instance->objval));
	if(RAMSEY_instance->status!=0)
	{
	...
	RAMSEY_instance->status=CPXgetbestobjval(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4,&(RAMSEY_instance->bestobjval));
	if(RAMSEY_instance->status!=0)
	{
		printf("error in CPXgetbestobjval\n");
	}

	RAMSEY_instance->lpstat=CPXgetstat(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4);
	RAMSEY_instance->nodecount = CPXgetnodecnt(RAMSEY_instance->env_MODEL_4, RAMSEY_instance->lp_MODEL_4);

	int cur_numcols=CPXgetnumcols(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4);
	int cur_numrows=CPXgetnumrows(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4);
	...
	if(SOL_FOUND)
	{
...
#ifdef PRINT_SOLUTION_MODEL_4
		cout << "\n\nR:\n";
		for(int i=0; i<RAMSEY_instance->PARAM_SIZE_GRAPH; i++)
		{
			for(int j=0; j<RAMSEY_instance->PARAM_SIZE_GRAPH; j++)
			{
				cout << (int)(RAMSEY_instance->X_MODEL_4[mapping(RAMSEY_instance,i,j)]+0.5);
			}
			cout << endl;
		}
		cout << endl;
		...
		for(int i=0; i<RAMSEY_instance->PARAM_SIZE_GRAPH; i++)
		{
			for(int j=0; j<RAMSEY_instance->PARAM_SIZE_GRAPH; j++)
			{
				cout << 1-(int)(RAMSEY_instance->X_MODEL_4[mapping(RAMSEY_instance,i,j)]+0.5);
			}
			cout << endl;
		}
		cout << endl;
		...
		for(int i=0; i<RAMSEY_instance->PARAM_SIZE_GRAPH; i++)
		{
			for(int j=0; j<RAMSEY_instance->PARAM_SIZE_GRAPH; j++)
			{
				if(RAMSEY_instance->X_MODEL_4[mapping(RAMSEY_instance,i,j)]<0.5)
				{
		...
		for(int i=0; i<RAMSEY_instance->PARAM_SIZE_GRAPH; i++)
		{
			for(int j=0; j<RAMSEY_instance->PARAM_SIZE_GRAPH; j++)
			{
				out << (int)(RAMSEY_instance->X_MODEL_4[mapping(RAMSEY_instance,i,j)]+0.5) << " ";
			}
			out << endl;
		}
		out << endl;
	...
	/////////////////////////////////////////////
	RAMSEY_MODEL_4_deallocation(RAMSEY_instance);
	/////////////////////////////////////////////
...
/***********************************************************************************/
{
	...
	RAMSEY_instance->status=CPXfreeprob(RAMSEY_instance->env_MODEL_4,&(RAMSEY_instance->lp_MODEL_4));
	if(RAMSEY_instance->status!=0) {printf("error in CPXfreeprob\n");exit(-1);}

	RAMSEY_instance->status=CPXcloseCPLEX(&(RAMSEY_instance->env_MODEL_4));
...
/***********************************************************************************/
{
	...
	/////////////////////////////////////////////
	RAMSEY_MODEL_4_allocation(RAMSEY_instance);
	/////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	RAMSEY_instance->env_MODEL_4=CPXopenCPLEX(&(RAMSEY_instance->status));
	if(RAMSEY_instance->status!=0)
	{
	...
	RAMSEY_instance->lp_MODEL_4=CPXcreateprob(RAMSEY_instance->env_MODEL_4,&(RAMSEY_instance->status),"RAMSEY");
	if(RAMSEY_instance->status!=0)
	{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	RAMSEY_instance->ccnt=RAMSEY_instance->n_variable_MODEL_4;
	...
	cout << "HOLA\n";
	RAMSEY_instance->status=CPXnewcols(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4,RAMSEY_instance->ccnt,RAMSEY_instance->obj,RAMSEY_instance->lb,RAMSEY_instance->ub,RAMSEY_instance->xctype,RAMSEY_instance->colname);
	...
	if(RAMSEY_instance->AVOID_TRIANGLES==1)
	{
		...
		int *MM=new int[RAMSEY_instance->n_variable_MODEL_4];
		...
		if(RAMSEY_instance->PARAM_N==3)
		{
			...
			for(int s=0; s< RAMSEY_instance->n_variable_MODEL_4; s++)
			{
				for(int t=s; t< RAMSEY_instance->n_variable_MODEL_4; t++)
				{
					...
					//					cout << "s\t" << s+1 << "\tt\t" << t+1 << "\th\t" << h+1 << endl;
					//					cout << "MM[s]\t" << MM[s] << "\tMM[t]\t" << MM[t] << "\tMM[h]\t" << MM[h] << endl;
					//					cin.get();


					RAMSEY_instance->status=CPXaddrows(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4,0,RAMSEY_instance->rcnt, ccnt, RAMSEY_instance->rhs,RAMSEY_instance->sense,RAMSEY_instance->rmatbeg,RAMSEY_instance->rmatind,RAMSEY_instance->rmatval,NULL,NULL);
					if(RAMSEY_instance->status!=0)
					{
	...
	if(RAMSEY_instance->AVOID_QUADRANGLES==1)
	{
		...
		if(RAMSEY_instance->PARAM_N==4)
		{
			...
			for(int s=0; s< RAMSEY_instance->n_variable_MODEL_4; s++)
			{
				for(int t=0; t< RAMSEY_instance->n_variable_MODEL_4; t++)
				{
					for(int u=0; u< RAMSEY_instance->n_variable_MODEL_4; u++)
					{
						...
						//						cout << "s\t" << s+1 << "\tt\t" << t+1 << "\tu\t" << u+1  << "\t";
						//						cout << "h_st\t" << h_st+1 << "\th_tu\t" << h_tu+1 << "\th_stu\t" << h_stu+1 << endl;
						//						cout << "MM[s]\t" << MM[s] << "\tMM[t]\t" << MM[t] << "\tMM[u]\t" << MM[u] << "\t";
						//						cout << "MM[h_st]\t" << MM[h_st] << "\tMM[h_tu]\t" << MM[h_tu] << "\tMM[h_stu]\t" << MM[h_stu] << endl;
						//						cin.get();
						//
	...
	if(RAMSEY_instance->PARAM_CLIQUE_JUMP_CUTS==1)
	{
		...
		for(int s=0; s< RAMSEY_instance->n_variable_MODEL_4; s++)
		{
			...
			RAMSEY_instance->rcnt=1;
			RAMSEY_instance->nzcnt=RAMSEY_instance->n_variable_MODEL_4;
			RAMSEY_instance->rhs=(double*) calloc(RAMSEY_instance->rcnt,sizeof(double));
			RAMSEY_instance->sense=(char*) calloc(RAMSEY_instance->rcnt,sizeof(double));
			...
			for(int k=1; k<=RAMSEY_instance->PARAM_N-1; k++)
			{
				...
				//				cout << "\tk=\t" << k << "\th(k)\t" << mapping_h(RAMSEY_instance, (s+1)*k) - 1;

			}

			//			cout << endl;

			RAMSEY_instance->status=CPXaddrows(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4,0,RAMSEY_instance->rcnt,
					RAMSEY_instance->nzcnt,
	...
	cout << "\n\n****MINIMIZATION\n\n";
	CPXchgobjsen(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4,CPX_MIN);



#ifdef	PRINT_MODEL_4_LP
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	// * writing the created ILP model on a file *
	RAMSEY_instance->status=CPXwriteprob(RAMSEY_instance->env_MODEL_4,RAMSEY_instance->lp_MODEL_4,"RAMSEY_MODEL_4.lp",NULL);
	if(RAMSEY_instance->status!=0)
	{
