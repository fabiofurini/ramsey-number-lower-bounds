...
//#define PRINT_SOLUTION_MODEL_1
//#define PRINT_SOLUTION_CALLBACK
//#define PRINT_MODEL_1_LP

/***********************************************************************************/
void RAMSEY_MODEL_1_allocation(data *RAMSEY_instance)
/***********************************************************************************/
{
	RAMSEY_instance->n_variable_MODEL_1=2*RAMSEY_instance->PARAM_SIZE_GRAPH*RAMSEY_instance->PARAM_SIZE_GRAPH;
	...
	RAMSEY_instance->X_CALLBACK=new double[RAMSEY_instance->n_variable_MODEL_1];
	RAMSEY_instance->cut_rmatind=new int[RAMSEY_instance->n_variable_MODEL_1];
	RAMSEY_instance->cut_rmatval=new double[RAMSEY_instance->n_variable_MODEL_1];

	RAMSEY_instance->X_MODEL_1=new double[RAMSEY_instance->n_variable_MODEL_1];
...
/***********************************************************************************/
void RAMSEY_MODEL_1_deallocation(data *RAMSEY_instance)
/***********************************************************************************/
{
	...
	delete []RAMSEY_instance->X_MODEL_1;
...
/***********************************************************************************/
int CPXPUBLIC mycutcallback_LAZY_MODEL_1(CPXCENVptr env,void *cbdata,int wherefrom,void *cbhandle,int *useraction_p)
/***********************************************************************************/
{
	...
	RAMSEY_instance->status=CPXgetcallbacknodex(env,cbdata,wherefrom,RAMSEY_instance->X_CALLBACK,0,RAMSEY_instance->n_variable_MODEL_1-1);
	...
	if(RAMSEY_instance->CLIQUE_VAL >=  RAMSEY_instance->PARAM_M )
	{
		...
		if(RAMSEY_instance->PARAM_STRONGER_CUTS==0 || RAMSEY_instance->CLIQUE_VAL ==  RAMSEY_instance->PARAM_M)
		{
			RAMSEY_instance->cut_RHS=RAMSEY_instance->CLIQUE_VAL-RAMSEY_instance->PARAM_M+1;
		...
		else
		{
			...
			RAMSEY_instance->cut_RHS=magic_formula(RAMSEY_instance->CLIQUE_VAL, RAMSEY_instance->PARAM_M);
			RAMSEY_instance->nzcnt=0;
...
/***********************************************************************************/
void RAMSEY_MODEL_1_parameter_setting(data *RAMSEY_instance)
/***********************************************************************************/
{

	// * Set printing *

	CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_SCRIND, CPX_ON);


	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_HEURFREQ, RAMSEY_instance->HEURFREQ);
	...
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_THREADS, RAMSEY_instance->NUMBER_OF_THREADS);
	if (RAMSEY_instance->status)
	{
	...
	//	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_PARALLELMODE, CPX_PARALLEL_DETERMINISTIC);
	//	if (RAMSEY_instance->status)
	//	{
	...
	RAMSEY_instance->status = CPXsetdblparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_TILIM,RAMSEY_instance->PARAM_TIME_LIMIT);
	if (RAMSEY_instance->status)
	{
	...
	RAMSEY_instance->status = CPXsetdblparam (RAMSEY_instance->env_MODEL_1, CPXPARAM_MIP_Limits_TreeMemory, 1024*4);
	if (RAMSEY_instance->status)
	{
	...
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_MIPEMPHASIS,CPX_MIPEMPHASIS_FEASIBILITY);
	if (RAMSEY_instance->status)
	{
	...
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_NODESEL, RAMSEY_instance->TREE_EXPLORATION_STRATEGY);
	if (RAMSEY_instance->status)
	{
	...
	//
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPXPARAM_MIP_Strategy_VariableSelect,RAMSEY_instance->BRANCHING_VARIABLE_SELECTION);
	if (RAMSEY_instance->status)
	{
		printf ("error for CPX_PARAM_MIPEMPHASIS\n");
	}
	...
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_INTSOLLIM,1);
	if (RAMSEY_instance->status)
	{
	...
	CPXsetintparam(RAMSEY_instance->env_MODEL_1, CPX_PARAM_MIPCBREDLP, CPX_OFF);        // let MIP callbacks work on the original model
	//	CPXsetintparam(RAMSEY_instance->env_MODEL_1, CPX_PARAM_PRELINEAR, CPX_OFF);              // assure linear mappings between the presolved and original models
	CPXsetintparam(RAMSEY_instance->env_MODEL_1, CPX_PARAM_REDUCE, CPX_PREREDUCE_PRIMALONLY);
	//	CPXsetintparam(RAMSEY_instance->env_MODEL_1, CPXPARAM_Preprocessing_Reduce, CPX_PREREDUCE_PRIMALONLY);
	//	CPXsetintparam(RAMSEY_instance->env_MODEL_1, CPXPARAM_Preprocessing_Linear, 0);


	RAMSEY_instance->status = CPXsetlazyconstraintcallbackfunc(RAMSEY_instance->env_MODEL_1,mycutcallback_LAZY_MODEL_1,RAMSEY_instance);
	if (RAMSEY_instance->status)
	{
		printf ("error for CPXsetlazyconstraintcallbackfunc\n");
	}

	RAMSEY_instance->status = CPXsetintparam(RAMSEY_instance->env_MODEL_1, CPX_PARAM_RANDOMSEED, RAMSEY_instance->RANDOM_SEED);
	if (RAMSEY_instance->status )
	{
	...
	if( RAMSEY_instance->BRANCHING_STRATEGY>0)
	{
		...
		RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, 		CPX_PARAM_MIPORDIND,1);
		if (RAMSEY_instance->status)
		{
		...
		RAMSEY_instance-> status = CPXcopyorder (RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1, RAMSEY_instance->PARAM_SIZE_GRAPH*RAMSEY_instance->PARAM_SIZE_GRAPH, indices, priority,direction);
		if (RAMSEY_instance->status)
		{
	...
	{
		RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_NODELIM, RAMSEY_instance->PARAM_CUT_LOOP);
		if (RAMSEY_instance->status)
		{
		...
		RAMSEY_instance->status=CPXmipopt(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1);
		if(RAMSEY_instance->status!=0)
		{
		...
		RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_NODELIM, 2100000000);
		if (RAMSEY_instance->status)
		{
			printf ("error for CPX_PARAM_EPRHS\n");
		}
...
/***********************************************************************************/
{
	...
	//////////////////////////////////////////////////
	RAMSEY_MODEL_1_parameter_setting(RAMSEY_instance);
	//////////////////////////////////////////////////
	...
	bool SOL_FOUND=true;
	RAMSEY_instance->status=CPXgetmipx(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1,RAMSEY_instance->X_MODEL_1,0,RAMSEY_instance->n_variable_MODEL_1-1);
	if(RAMSEY_instance->status!=0)
	{
		SOL_FOUND=false;
	...
	RAMSEY_instance->status=CPXgetmipobjval(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1,&(RAMSEY_instance->objval));
	if(RAMSEY_instance->status!=0)
	{
	...
	RAMSEY_instance->status=CPXgetbestobjval(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1,&(RAMSEY_instance->bestobjval));
	if(RAMSEY_instance->status!=0)
	{
		printf("error in CPXgetbestobjval\n");
	}

	RAMSEY_instance->lpstat=CPXgetstat(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1);
	RAMSEY_instance->nodecount = CPXgetnodecnt(RAMSEY_instance->env_MODEL_1, RAMSEY_instance->lp_MODEL_1);

	int cur_numcols=CPXgetnumcols(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1);
	int cur_numrows=CPXgetnumrows(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1);
	...
	if(SOL_FOUND)
	{
...
#ifdef PRINT_SOLUTION_MODEL_1
		cout << "\n\nR:\n";
		for(int i=0; i<RAMSEY_instance->PARAM_SIZE_GRAPH; i++)
		{
			for(int j=0; j<RAMSEY_instance->PARAM_SIZE_GRAPH; j++)
			{
				cout << (int)(RAMSEY_instance->X_MODEL_1[position_r(RAMSEY_instance,i,j)]+0.5);
			}
			cout << endl;
		}
		cout << endl;
		...
		for(int i=0; i<RAMSEY_instance->PARAM_SIZE_GRAPH; i++)
		{
			for(int j=0; j<RAMSEY_instance->PARAM_SIZE_GRAPH; j++)
			{
				cout << (int)(RAMSEY_instance->X_MODEL_1[position_b(RAMSEY_instance,i,j)]+0.5);
			}
			cout << endl;
		}
		cout << endl;
		...
		for(int i=0; i<RAMSEY_instance->PARAM_SIZE_GRAPH; i++)
		{
			for(int j=0; j<RAMSEY_instance->PARAM_SIZE_GRAPH; j++)
			{
				out << (int)(RAMSEY_instance->X_MODEL_1[position_b(RAMSEY_instance,i,j)]+0.5) << " ";
			}
			out << endl;
		}
		out << endl;
		...
		write_row_sol(RAMSEY_instance, RAMSEY_instance->X_MODEL_1);
		////////////////////////////////////////////////////////////////////////////////////////

		if(RAMSEY_instance->CHECK_SOLUTION==1)
		{
			////////////////////////////////////////////////////////////////////////
			bool OK_SOL=check_solution(RAMSEY_instance,RAMSEY_instance->X_MODEL_1);
			if(!OK_SOL)
			{
	...
	/////////////////////////////////////////////
	RAMSEY_MODEL_1_deallocation(RAMSEY_instance);
	/////////////////////////////////////////////
...
/***********************************************************************************/
{
	...
	RAMSEY_instance->status=CPXfreeprob(RAMSEY_instance->env_MODEL_1,&(RAMSEY_instance->lp_MODEL_1));
	if(RAMSEY_instance->status!=0) {printf("error in CPXfreeprob\n");exit(-1);}

	RAMSEY_instance->status=CPXcloseCPLEX(&(RAMSEY_instance->env_MODEL_1));
...
/***********************************************************************************/
{
	...
	/////////////////////////////////////////////
	RAMSEY_MODEL_1_allocation(RAMSEY_instance);
	/////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	RAMSEY_instance->env_MODEL_1=CPXopenCPLEX(&(RAMSEY_instance->status));
	if(RAMSEY_instance->status!=0)
	{
	...
	RAMSEY_instance->lp_MODEL_1=CPXcreateprob(RAMSEY_instance->env_MODEL_1,&(RAMSEY_instance->status),"RAMSEY");
	if(RAMSEY_instance->status!=0)
	{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	RAMSEY_instance->ccnt=RAMSEY_instance->n_variable_MODEL_1;
	...
	RAMSEY_instance->status=CPXnewcols(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1,RAMSEY_instance->ccnt,RAMSEY_instance->obj,RAMSEY_instance->lb,RAMSEY_instance->ub,RAMSEY_instance->xctype,RAMSEY_instance->colname);
	if(RAMSEY_instance->status!=0)
	{
	...
	cout << "\n\n****MAXIMIZATION\n\n";
	CPXchgobjsen(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1,CPX_MAX);
	...
	for(int i=0; i<RAMSEY_instance->PARAM_SIZE_GRAPH; i++)
	{
		for(int j=i+1; j<RAMSEY_instance->PARAM_SIZE_GRAPH; j++)
		{
			...
			RAMSEY_instance->status=CPXaddrows(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1,0,RAMSEY_instance->rcnt,RAMSEY_instance->nzcnt,RAMSEY_instance->rhs,RAMSEY_instance->sense,RAMSEY_instance->rmatbeg,RAMSEY_instance->rmatind,RAMSEY_instance->rmatval,NULL,NULL);
			if(RAMSEY_instance->status!=0)
			{
...
#ifdef	PRINT_MODEL_1_LP
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	// * writing the created ILP model on a file *
	RAMSEY_instance->status=CPXwriteprob(RAMSEY_instance->env_MODEL_1,RAMSEY_instance->lp_MODEL_1,"RAMSEY_MODEL_1.lp",NULL);
	if(RAMSEY_instance->status!=0)
	{
