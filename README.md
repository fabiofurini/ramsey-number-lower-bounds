...
3. **Inspect the lower bounds reported in the paper.** Open [`lower-bounds/README.md`](lower-bounds/README.md) to access the lower bounds computed and presented in the paper, together with their graph certificates and coloured visualisations.
